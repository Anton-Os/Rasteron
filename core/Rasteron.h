...
Rasteron_Image* noiseExtImgOp(ImageSize size, ColorGrid grid, noiseCallback callback); // extended version that can be reused
Rasteron_Image* noiseExtImgOp_wave(ImageSize size, ColorGrid grid, noiseCallback callback, unsigned short amplitude); // amount wave deviates
