...
void setupCanvas(char input){
	...
	switch(keysave){
		...
		case 'e': canvasImg = wordsmithImgOp(0xFFEEEEEE, 0xFF000000); break;
		...
		case 'j': canvasImg = knittingImgOp(32, pArg + 4); break;
		case 'k': canvasImg = perturbImgOp(xArg + 0.5F, yArg + 0.5); break;
		case 'l': canvasImg = reliefImgOp(1.0); break;
		case 'm': canvasImg = stratifyImgOp(3); break;
		case 'n': canvasImg = turingPatternImgOp(RAND_COLOR(), RAND_COLOR()); break;
